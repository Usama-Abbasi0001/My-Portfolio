      ...
      >
        <div className="flex flex-col lg:flex-row space-y-5 md:space-y-0 lg:space-x-4 rounded-[10px] p-5 shadow-lg border-t-2 border-red-500 shadow-red-500">
          ...
          <div className="pt-5 px-3 md:pt-7 md:px-5 rounded-lg flex flex-col space-y-5">
            ...
            >
              <p className="text-lg md:text-[25px] font-bold">{projectTitle}</p>
            ...
            {/* Tools Section */}
            <div className="flex flex-col md:flex-row md:justify-between items-start md:items-center w-full space-y-3 md:space-y-0 lg:pt-[7rem] pt-0">
              <p className="text-sm font-semibold">Tools</p>
              <p className="text-sm md:text-base w-full md:w-[230px]">{tools}</p>
            </div>
          </div>
        </div>
      </div>
